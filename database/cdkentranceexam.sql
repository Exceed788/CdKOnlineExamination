...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2021 at 01:03 PM
...
CREATE TABLE `examineecode_tbl` (
  `exmne_id` int(11) NOT NULL,
  `exmne_code` varchar(1000) NOT NULL,
  `code_status` varchar(20) NOT NULL,
  `code_created` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
