     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
		  ...
		  <div class="form-group">
            <label>Code</label>
            <input type="codeno" name="codeno" id="codeno" class="form-control" placeholder="Input Code" autocomplete="off" required="">
          </div>
...
<!-- Modal For Add New Codes -->
<div class="modal fade myModal" id="modalForAddCodes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="addNewCodesFrm" method="post" >
       <div class="modal-content myModal-content" >
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="number_of_codes" id="number_of_codes" class="form-control" value="0">
            </div>
          </div>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary">Add New Codes</button>
        </div>
      </div>
     </form>
    </div>
...
<!-- Modal For Update Codes -->
<div class="modal fade myModal" id="modalForUpdateCodes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="updateCodesFrm" method="post" >
       <div class="modal-content myModal-content" >
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update Codes</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
